...
function DashboardPreviewSmall() {
    ...
    return (
        <div className="lg:hidden top-0 fixed">
            <div
            ...
            <div className={`${navOpen ? "flex" : "hidden"} top-0 sticky h-full w-[30vw]`}>
...
export default DashboardPreviewSmall;
