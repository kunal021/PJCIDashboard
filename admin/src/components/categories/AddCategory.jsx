  ...
  return (
    <div className="container flex flex-col justify-center items-center">
      ...
      <button
        ...
        className="border-2 rounded-lg border-red-500 py-2 px-4 text-sm font-semibold text-red-500 hover:border-transparent hover:bg-red-500 hover:text-white transition-all duration-500 w-full md:w-auto"
      >
        Close
      </button>
    </div>
