...
function AddCourse() {
  ...
  return (
    <div className="container w-[85%] flex flex-col justify-center items-center mx-5">
      <h1 className="text-center my-5 text-3xl font-bold">Add Category</h1>
      <div className="flex flex-col justify-center items-center max-w-md lg:w-full mx-auto mt-5">
        ...
        <div className="flex items-center justify-between mb-4">
          <Link
            to={"/get-course"}
            className="border-2 rounded-md border-red-500 py-2 px-4 text-sm font-semibold text-red-500 hover:border-transparent hover:bg-red-500 hover:text-white transition-all duration-500 w-full md:w-auto"
          >
            Close
          </Link>
        </div>
