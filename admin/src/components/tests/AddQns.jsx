    ...
    <div className="flex flex-col justify-center items-center max-w-md lg:w-full mx-auto mt-5">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center space-y-4">
          <p className="text-center text-lg font-bold">Select Correct Answer</p>
          <div className="flex justify-center items-center space-x-6">
            <input type="checkbox" id="ans_a" name="a" value="a" className="hidden" checked={checked.a} onChange={(e) => {
              handleCheckbox(e);
              handleChange(e);
            }} />
            <label htmlFor="ans_a" className="checkbox-label">A</label>
            <input type="checkbox" id="ans_b" name="b" value="b" className="hidden" checked={checked.b} onChange={(e) => {
              handleCheckbox(e);
              handleChange(e);
            }} />
            <label htmlFor="ans_b" className="checkbox-label">B</label>
            <input type="checkbox" id="ans_c" name="c" value="c" className="hidden" checked={checked.c} onChange={(e) => {
              handleCheckbox(e);
              handleChange(e);
            }} />
            <label htmlFor="ans_c" className="checkbox-label">C</label>
            <input type="checkbox" id="ans_d" name="d" value="d" className="hidden" checked={checked.d} onChange={(e) => {
              handleCheckbox(e);
              handleChange(e);
            }} />
            <label htmlFor="ans_d" className="checkbox-label">D</label>
            <input type="checkbox" id="ans_e" name="e" value="e" className="hidden" checked={checked.e} onChange={(e) => {
              handleCheckbox(e);
              handleChange(e);
            }} />
